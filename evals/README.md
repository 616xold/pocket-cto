...
- keep broader packet-circulation grading beyond `board_packet`, actual delivery grading, PDF export, slide or Marp export, and runtime-codex drafting evaluation reserved for a later narrow post-F5C4F correction/chronology slice rather than treating F5C4F as still active
