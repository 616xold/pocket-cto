...
- Keep FP-0110 default local dispatch planning scoped to explicit app construction, one expected `companyKey`, existing local read-only evidence artifact lanes, and no-real-finance-data/no-public-demo-data proof gates until a later implementation plan opens runtime wiring.
