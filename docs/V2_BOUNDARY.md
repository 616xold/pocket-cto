...
- ChatGPT App/MCP is worth keeping as a read-only evidence wrapper path after EvidenceIndex, V2B precision proof, the shipped FP-0082 local/internal tool contract, the shipped FP-0083 OSS/security/privacy/self-host/demo baseline, the shipped V2E bounded-orchestration posture, the shipped V2F no-real-finance-data benchmark/community posture, and the shipped FP-0087 local proof-only contract and descriptor/envelope foundation. MCP server runtime, public ChatGPT App implementation, Apps SDK UI, remote deployment, OAuth, and app publication remain future implementation work.
- iOS is postponed.
