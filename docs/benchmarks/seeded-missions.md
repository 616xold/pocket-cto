...
`plans/FP-0051-alert-to-investigation-mission-foundation.md` is the shipped F6B benchmark record. Do not add a broader F6 benchmark dataset or start F6C implementation before a new named Finance Plan defines the next monitor scope.
