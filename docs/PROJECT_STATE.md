...
- **V2T read-only ChatGPT App/MCP public-app security boundary contracts foundation**: shipped through FP-0100.

## Active V2 Plan

- No unfinished V2 Finance Plan is open after [FP-0100](../plans/FP-0100-read-only-chatgpt-app-mcp-public-app-security-boundary-contracts-foundation.md) closeout. Public app implementation, route/UI implementation beyond the FP-0094/FP-0096/FP-0097 single local route boundary, endpoints, remote MCP deployment, Apps SDK UI resources, OAuth, app submission, provider/certification/delivery/deployment, and V2G expansion beyond the shipped local proof-only contracts, descriptor/envelope foundation, FP-0098 readiness/security/submission-boundary plan, FP-0099 security threat-model/platform-boundary plan, and FP-0100 local security boundary contracts still require a later named Finance Plan.
