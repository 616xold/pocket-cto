...
- **V2V read-only ChatGPT App/MCP endpoint/OAuth/remote-MCP architecture master plan**: shipped through FP-0102.

## Active V2 Plan

- No unfinished V2 Finance Plan is open after [FP-0102](../plans/FP-0102-read-only-chatgpt-app-mcp-endpoint-oauth-remote-mcp-architecture-master-plan.md) closeout. Public app implementation, route/UI implementation beyond the FP-0094/FP-0096/FP-0097 single local route boundary, endpoints, OAuth/token/session implementation, remote MCP deployment, Apps SDK UI resources, app submission, provider/certification/delivery/deployment, and V2G expansion beyond the shipped local proof-only contracts, descriptor/envelope foundation, FP-0098 readiness/security/submission-boundary plan, FP-0099 security threat-model/platform-boundary plan, FP-0100 local security boundary contracts, FP-0101 implementation sequencing/platform-readiness plan, and FP-0102 endpoint/OAuth/remote-MCP architecture plan still require a later named Finance Plan.
