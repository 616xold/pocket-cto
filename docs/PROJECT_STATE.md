...
- **V2U read-only ChatGPT App/MCP public-app implementation sequencing master plan**: shipped through FP-0101.

## Active V2 Plan

- No unfinished V2 Finance Plan is open after [FP-0101](../plans/FP-0101-read-only-chatgpt-app-mcp-public-app-implementation-sequencing-master-plan.md) closeout. Public app implementation, route/UI implementation beyond the FP-0094/FP-0096/FP-0097 single local route boundary, endpoints, remote MCP deployment, Apps SDK UI resources, OAuth, app submission, provider/certification/delivery/deployment, and V2G expansion beyond the shipped local proof-only contracts, descriptor/envelope foundation, FP-0098 readiness/security/submission-boundary plan, FP-0099 security threat-model/platform-boundary plan, FP-0100 local security boundary contracts, and FP-0101 implementation sequencing/platform-readiness plan still require a later named Finance Plan.
