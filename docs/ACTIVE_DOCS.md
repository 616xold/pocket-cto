...
- ChatGPT App/MCP implementation beyond the shipped FP-0087 local proof-only contract and descriptor/envelope foundation and the shipped local/internal FP-0082 contract
