...
The shipped F6A record is now `plans/FP-0050-monitoring-foundation-and-first-cash-posture-alert.md`. The shipped F6B record is now `plans/FP-0051-alert-to-investigation-mission-foundation.md`. The shipped F6C record is now `plans/FP-0052-collections-pressure-monitor-foundation.md`. The shipped F6D record is now `plans/FP-0053-payables-pressure-monitor-foundation.md`. Do not create runtime-codex monitoring behavior, notification delivery, automatic mission creation, investigations, approvals, report conversion, payment behavior, payment instructions, vendor-payment recommendations, or F6E and later monitor work from this doc alone; later F6 slices need new named Finance Plans.
