...
`plans/FP-0077-v1-public-launch-handoff.md` is the active F10/v1 public launch handoff planning contract. It must not add runtime-Codex finance actions, public launch drafting, notification prose, external communication prose, provider integration, actual certification, delivery, report release, report circulation, approval workflow, source mutation, finance writes, generated prose, UI action controls, product runtime behavior, or autonomous action.
