...
- `FP-0077` is the active F10/v1 public launch handoff planning contract; it is docs-and-validation-only and does not add source ingest, CFO Wiki compiler behavior, product runtime behavior, provider integrations, delivery, outbox sends, report release, approvals, actual certification, runtime-codex, generated prose, source mutation, finance writes, PDF/OCR/vector search, UI, monitor family, discovery family, mission behavior, or autonomous action
