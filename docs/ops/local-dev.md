...
`plans/FP-0048-board-packet-circulation-actor-correction-and-chronology-hardening.md` is now the active F5C4H contract and already includes the first shipped actor-correction slice for corrected board-circulation attribution on that same append-only seam.
