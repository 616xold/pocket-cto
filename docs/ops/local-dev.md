...
`plans/FP-0051-alert-to-investigation-mission-foundation.md` now records the shipped first F6B implementation slice. Do not start broader later-F5 work, multi-monitor F6 work, F6C or later implementation, runtime-codex monitoring, delivery behavior, notifications, or automatic mission creation from this doc.
...
Step 6 now starts from the shipped FP-0050 monitoring record and the shipped FP-0051 alert-to-investigation record.
...
`plans/FP-0050-monitoring-foundation-and-first-cash-posture-alert.md` is the shipped first F6A implementation record. `plans/FP-0051-alert-to-investigation-mission-foundation.md` is the shipped first F6B implementation record; do not reopen F4C2, repeat F5A through F5C4I, or widen beyond one manual `cash_posture` alert-to-investigation handoff without a new named Finance Plan.
