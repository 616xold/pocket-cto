...
There is not yet a checked-in active later-F5 implementation contract after FP-0049. Do not start broader later-F5 or F6 implementation from this doc alone; begin any next F6 follow-on with planning/docs and a new Finance Plan before code changes.
...
There is not currently a checked-in active later-F5 reporting contract after FP-0049. Do not reopen F4C2 or repeat F5A through F5C4I; if F6 work starts next, begin with planning/docs and create the next Finance Plan before code changes.
