...
`plans/FP-0047-board-packet-circulation-record-correction-and-chronology-foundation.md` is the current active later-F5 reporting plan, and `plans/FP-0046-circulation-log-and-first-board-packet-circulation-record-foundation.md` remains the latest shipped later-F5 reporting record.
Do not reopen F4C2, do not repeat F5A through F5C4F work, and do not start F6 early; the next code thread should execute the narrow F5C4G board circulation-record correction/chronology slice before any broader later-F5 umbrella plan.
