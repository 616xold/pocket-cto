...
6. run discovery, reporting, and monitoring work only through the current active Finance Plan; FP-0052 records the shipped F6C collections-pressure monitor slice, FP-0053 records the shipped F6D payables-pressure monitor slice, and FP-0054 records the shipped F6E policy/covenant threshold monitor slice
