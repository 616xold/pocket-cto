...
Do not reopen F4C2, do not repeat F5A through F5C3 work, and do not start F6 early; the next plan to author is the narrow F5C4 approval-release hardening contract.
