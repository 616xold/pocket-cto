...
Do not reopen F4C2, do not repeat F5A through F5C4D work, and do not start F6 early; the next code thread should define or implement the narrow F5C4E board-packet review or circulation readiness slice rather than authoring another broad later-F5 umbrella plan.
