...
`plans/FP-0052-collections-pressure-monitor-foundation.md` is now the active F6C implementation-ready contract for exactly one deterministic `collections_pressure` monitor over stored receivables-aging or collections-posture Finance Twin state. Do not start broader later-F5 work, multi-monitor F6 work, F6D or later implementation, runtime-codex monitoring, delivery behavior, notifications, investigations, approvals, report conversion, or automatic mission creation from this doc.
...
Step 6 now starts from the shipped FP-0050 monitoring record, the shipped FP-0051 alert-to-investigation record, and the active FP-0052 collections-pressure monitor implementation contract.
...
`plans/FP-0050-monitoring-foundation-and-first-cash-posture-alert.md` is the shipped first F6A implementation record. `plans/FP-0051-alert-to-investigation-mission-foundation.md` is the shipped first F6B implementation record. `plans/FP-0052-collections-pressure-monitor-foundation.md` is the active F6C implementation-ready contract; do not reopen F4C2, repeat F5A through F5C4I, or widen beyond one deterministic `collections_pressure` monitor without a new named Finance Plan.
