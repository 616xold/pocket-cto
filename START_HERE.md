...
`plans/FP-0052-collections-pressure-monitor-foundation.md` is now the active F6C implementation-ready contract for exactly one `collections_pressure` monitor over stored receivables-aging or collections-posture Finance Twin state. Do not start F6D or later, create FP-0053, or widen F6C into runtime-codex, delivery, investigations, approvals, report conversion, or multi-monitor work.
