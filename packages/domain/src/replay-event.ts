...
export const ApprovalRequestedPayloadSchema = z.object({
  ...
  requestId: z.union([z.string(), z.number()]).nullable().default(null),
  requestMethod: RuntimeApprovalRequestMethodSchema.nullable().default(null),
