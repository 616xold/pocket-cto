...
The active next step is `plans/FP-0048-board-packet-circulation-actor-correction-and-chronology-hardening.md`, which keeps this same approvals seam as the persistence anchor and narrows any remaining later-F5 work to optional corrected `circulatedBy` on correction entries plus derived effective actor chronology, with no new approval kind and no delivery widening.
