...
The active narrow step is `plans/FP-0048-board-packet-circulation-actor-correction-and-chronology-hardening.md`, which already ships optional corrected `circulatedBy` on correction entries plus derived effective actor chronology on this same approvals seam, with no new approval kind and no delivery widening.
