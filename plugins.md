...
This file records the plugins available in this Codex local thread and the repo-local Pocket CFO plugin used for the FP-0098 docs-and-plan-only public-app readiness/security/submission-boundary planning and same-branch QA slice.
...
- `pocket-cfo-codex-operator`
  ...
  - Skills invoked for this FP-0098 same-branch public-app readiness/security/submission-boundary planning and QA slice:
...
- OpenAI Developers was available but was not used to create API keys, call OpenAI APIs, call models, or widen app/runtime scope. Official OpenAI web docs were used read-only as current platform/security/submission context and were recorded in FP-0098.
