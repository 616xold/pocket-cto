...
- `F6I — stack-pack expansion`
  - later only after the first F6F demo pack is green; do not create from FP-0056
- `F6J — notification/delivery planning`
  - later planning only, and only if a future plan proves a safe human-review, delivery-free-by-default path; do not create from FP-0056
