...
- optional ChatGPT App/MCP implementation, route expansion beyond FP-0107, protected-resource metadata route implementation, WWW-Authenticate route behavior, endpoint/OAuth/remote MCP implementation, auth middleware implementation, Apps SDK resource implementation, app submission, iOS, OpenClaw, deployment, default/public evidence dispatch beyond FP-0111 explicit local wiring, or other distribution tracks require later named Finance Plans after V2 foundations and active FP-0120 canonical resource/auth-server readiness gates are proven
