...
- `F6G — non-cash alert-to-investigation generalization`
  - later only and only if a concrete operator need proves a narrow safe path for non-cash alerts; create a new Finance Plan before implementation
